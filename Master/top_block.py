...
# Title: Top Block
# Generated: Sat Apr 14 12:42:24 2018
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def set_zero_freq(self, zero_freq):
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 400000, 1000, firdes.WIN_HAMMING, 6.76))
        self.digital_clock_recovery_mm_xx_0.set_omega(self.samp_rate/(self.baud_rate*5))
        self.blocks_repeat_0.set_interpolation(self.samp_rate/self.baud_rate)
    ...
    def get_one_freq(self):
        return self.one_freq

    def set_one_freq(self, one_freq):
        self.one_freq = one_freq
